...
def migrate(json_file, isVersion):
    ...
    # fix persistentIdentitySystems - persistentIdentityEntityTypeSchemes wrapper name
    persistentIdentitySystems = datasource.find('{http://einfracentral.eu}persistentIdentitySystems')
    if persistentIdentitySystems is not None:
        for persistentIdentitySystem in persistentIdentitySystems:
            if persistentIdentitySystem is not None:
                persistentIdentityEntityTypeSchemes = persistentIdentitySystem.find('{http://einfracentral.eu}persistentIdentityEntityTypeSchemes')
                if persistentIdentityEntityTypeSchemes is not None:
                    for persistentIdentityEntityTypeScheme in persistentIdentityEntityTypeSchemes:
                        if persistentIdentityEntityTypeScheme is not None:
