...
access_research_infrastructures = ['openrisknet.jaqpot',
...
access_training_material = ['bifi_-_unizar.hm', 'e-cam.e-cam_online_training_portal',
                            'collabwith.collabwith_marketplace',
...
discover_research_outputs = ['elsevier.digital_commons', 'seadatanet.marine_data_viewer', 'esa-int.geoss_web_portal',
                             ...
                             'embl-ebi.icr', 'hits.fairdomhub', 'ror-org.ror', 'seadatanet.marine_data_viewer',
                             ...
                             'eosc.seadatanet.marine_data_viewer', 'eosc.cern.cod', 'eosc.awi_bremerhaven.pangaea',
                             'eosc.ceric-eric.ceric-data-portal',
